...
var GithubActionsTimeoutMinutesOptionsSchema = import_zod5.z.object({
  maximum: import_zod5.z.number().positive().optional()
});
var GithubActionsTimeoutMinutesSchema = import_zod5.z.object({
  name: import_zod5.z.literal("github-actions/timeout-minutes"),
  level: AlertLevelSchema,
...
var LicenseExistsOptionsSchema = import_zod6.z.object({
  caseSensitive: import_zod6.z.boolean().default(false),
  path: import_zod6.z.union([import_zod6.z.string(), import_zod6.z.array(import_zod6.z.string()).min(1)]).default("LICENSE.md")
});
var LicenseExistsSchema = import_zod6.z.object({
  name: import_zod6.z.literal("license/exists"),
  level: AlertLevelSchema,
...
var PyprojectDependenciesAlphabeticalOrderOptionsSchema = import_zod7.z.object({
  path: import_zod7.z.string().default("pyproject.toml"),
  sections: import_zod7.z.array(import_zod7.z.string()).default(["project.dependencies", "project.optional-dependencies", "tool.poetry.dependencies"])
});
var PyprojectDependenciesAlphabeticalOrderSchema = import_zod7.z.object({
  name: import_zod7.z.literal("python/pyproject-dependencies-alphabetical-order"),
  level: AlertLevelSchema,
...
var ReadmeExistsOptionsSchema = import_zod8.z.object({
  caseSensitive: import_zod8.z.boolean().optional().default(false),
  path: import_zod8.z.union([import_zod8.z.string(), import_zod8.z.array(import_zod8.z.string()).min(1)]).optional().default("README.md")
});
var ReadmeExistsSchema = import_zod8.z.object({
  name: import_zod8.z.literal("readme/exists"),
  level: AlertLevelSchema,
...
// src/rules/requirements-txt-dependencies-alphabetical-order.ts
var RequirementsTxtDependenciesAlphabeticalOrderOptionsSchema = import_zod9.z.object({
  path: import_zod9.z.string().default("requirements.txt")
});
var RequirementsTxtDependenciesAlphabeticalOrderSchema = import_zod9.z.object({
  name: import_zod9.z.literal("python/requirements-txt-dependencies-alphabetical-order"),
  level: AlertLevelSchema,
...
var ruleConfigSchema = import_zod10.default.union([
  FileContainsSchema,
  FileExistsSchema,
  FileForbiddenSchema,
...
var rulesConfigSchema = import_zod10.default.array(ruleConfigSchema);

// src/utils/config.ts
var regexPatternSchema = import_zod11.z.string().refine(
  (pattern) => {
    try {
      new RegExp(pattern);
      return true;
...
var filtersSchema = import_zod11.z.object({
  archived: import_zod11.z.boolean().optional(),
  organizations: import_zod11.z.array(import_zod11.z.string()).optional(),
  visibility: import_zod11.z.enum(["public", "private", "all"]).optional(),
  include: import_zod11.z.array(regexPatternSchema).optional(),
  exclude: import_zod11.z.array(regexPatternSchema).optional()
});
var configSchema = import_zod11.z.object({
