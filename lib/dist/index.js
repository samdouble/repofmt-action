...
// src/rules/requirements-txt-dependencies-alphabetical-order.ts
var RequirementsTxtDependenciesAlphabeticalOrderOptionsSchema = import_zod13.z.object({
  path: import_zod13.z.string().default("requirements.txt")
});
...
var YamlHasKeysOptionsSchema = import_zod14.z.object({
  path: import_zod14.z.union([import_zod14.z.string(), import_zod14.z.array(import_zod14.z.string()).min(1)]),
  keys: import_zod14.z.array(import_zod14.z.string()).min(1)
});
...
var ruleConfigSchema = import_zod15.default.union([
  FileContainsSchema,
...
var rulesConfigSchema = import_zod15.default.array(ruleConfigSchema);

// src/utils/config.ts
var regexPatternSchema2 = import_zod16.z.string().refine(
  (pattern) => {
    try {
      new RegExp(pattern);
      return true;
...
var filtersSchema = import_zod16.z.object({
  archived: import_zod16.z.boolean().optional(),
  organizations: import_zod16.z.array(import_zod16.z.string()).optional(),
  visibility: import_zod16.z.enum(["public", "private", "all"]).optional(),
  include: import_zod16.z.array(regexPatternSchema2).optional(),
  exclude: import_zod16.z.array(regexPatternSchema2).optional()
});
var configSchema = import_zod16.z.object({
