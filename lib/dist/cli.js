...
var ruleConfigSchema = import_zod9.default.union([
  FileContainsSchema,
  FileExistsSchema,
  FileForbiddenSchema,
...
var rulesConfigSchema = import_zod9.default.array(ruleConfigSchema);

// src/utils/config.ts
var regexPatternSchema = import_zod10.z.string().refine(
  (pattern) => {
    try {
      new RegExp(pattern);
      return true;
...
var filtersSchema = import_zod10.z.object({
  archived: import_zod10.z.boolean().optional(),
  organizations: import_zod10.z.array(import_zod10.z.string()).optional(),
  visibility: import_zod10.z.enum(["public", "private", "all"]).optional(),
  include: import_zod10.z.array(regexPatternSchema).optional(),
  exclude: import_zod10.z.array(regexPatternSchema).optional()
});
var configSchema = import_zod10.z.object({
