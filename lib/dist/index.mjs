...
// src/rules/requirements-txt-dependencies-alphabetical-order.ts
var RequirementsTxtDependenciesAlphabeticalOrderOptionsSchema = z12.object({
  path: z12.string().default("requirements.txt")
});
...
var YamlHasKeysOptionsSchema = z13.object({
  path: z13.union([z13.string(), z13.array(z13.string()).min(1)]),
  keys: z13.array(z13.string()).min(1)
});
...
// src/rules/index.ts
import z14 from "zod";
var ruleConfigSchema = z14.union([
  FileContainsSchema,
...
var rulesConfigSchema = z14.array(ruleConfigSchema);

// src/utils/config.ts
var regexPatternSchema2 = z15.string().refine(
  (pattern) => {
    try {
      new RegExp(pattern);
      return true;
...
var filtersSchema = z15.object({
  archived: z15.boolean().optional(),
  organizations: z15.array(z15.string()).optional(),
  visibility: z15.enum(["public", "private", "all"]).optional(),
  include: z15.array(regexPatternSchema2).optional(),
  exclude: z15.array(regexPatternSchema2).optional()
});
