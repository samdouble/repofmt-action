...
var rulesConfigSchema = z9.array(ruleConfigSchema);

// src/utils/config.ts
var regexPatternSchema = z10.string().refine(
  (pattern) => {
    try {
      new RegExp(pattern);
      return true;
...
var filtersSchema = z10.object({
  archived: z10.boolean().optional(),
  organizations: z10.array(z10.string()).optional(),
  visibility: z10.enum(["public", "private", "all"]).optional(),
  include: z10.array(regexPatternSchema).optional(),
  exclude: z10.array(regexPatternSchema).optional()
});
