...
// src/rules/requirements-txt-dependencies-alphabetical-order.ts
var RequirementsTxtDependenciesAlphabeticalOrderOptionsSchema = z13.object({
  path: z13.string().default("requirements.txt")
});
...
var YamlHasKeysOptionsSchema = z14.object({
  path: z14.union([z14.string(), z14.array(z14.string()).min(1)]),
  keys: z14.array(z14.string()).min(1)
});
...
// src/rules/index.ts
import z15 from "zod";
var ruleConfigSchema = z15.union([
  FileContainsSchema,
...
var rulesConfigSchema = z15.array(ruleConfigSchema);

// src/utils/config.ts
var regexPatternSchema2 = z16.string().refine(
  (pattern) => {
    try {
      new RegExp(pattern);
      return true;
...
var filtersSchema = z16.object({
  archived: z16.boolean().optional(),
  organizations: z16.array(z16.string()).optional(),
  visibility: z16.enum(["public", "private", "all"]).optional(),
  include: z16.array(regexPatternSchema2).optional(),
  exclude: z16.array(regexPatternSchema2).optional()
});
