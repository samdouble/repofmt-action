...
var GithubActionsTimeoutMinutesOptionsSchema = z5.object({
  maximum: z5.number().positive().optional()
});
var GithubActionsTimeoutMinutesSchema = z5.object({
  name: z5.literal("github-actions/timeout-minutes"),
  level: AlertLevelSchema,
...
var LicenseExistsOptionsSchema = z6.object({
  caseSensitive: z6.boolean().default(false),
  path: z6.union([z6.string(), z6.array(z6.string()).min(1)]).default("LICENSE.md")
});
var LicenseExistsSchema = z6.object({
  name: z6.literal("license/exists"),
  level: AlertLevelSchema,
...
var PyprojectDependenciesAlphabeticalOrderOptionsSchema = z7.object({
  path: z7.string().default("pyproject.toml"),
  sections: z7.array(z7.string()).default(["project.dependencies", "project.optional-dependencies", "tool.poetry.dependencies"])
});
var PyprojectDependenciesAlphabeticalOrderSchema = z7.object({
  name: z7.literal("python/pyproject-dependencies-alphabetical-order"),
  level: AlertLevelSchema,
...
var ReadmeExistsOptionsSchema = z8.object({
  caseSensitive: z8.boolean().optional().default(false),
  path: z8.union([z8.string(), z8.array(z8.string()).min(1)]).optional().default("README.md")
});
var ReadmeExistsSchema = z8.object({
  name: z8.literal("readme/exists"),
  level: AlertLevelSchema,
...
// src/rules/requirements-txt-dependencies-alphabetical-order.ts
var RequirementsTxtDependenciesAlphabeticalOrderOptionsSchema = z9.object({
  path: z9.string().default("requirements.txt")
});
var RequirementsTxtDependenciesAlphabeticalOrderSchema = z9.object({
  name: z9.literal("python/requirements-txt-dependencies-alphabetical-order"),
  level: AlertLevelSchema,
...
// src/rules/index.ts
import z10 from "zod";
var ruleConfigSchema = z10.union([
  FileContainsSchema,
  FileExistsSchema,
  FileForbiddenSchema,
...
var rulesConfigSchema = z10.array(ruleConfigSchema);

// src/utils/config.ts
var regexPatternSchema = z11.string().refine(
  (pattern) => {
    try {
      new RegExp(pattern);
      return true;
...
var filtersSchema = z11.object({
  archived: z11.boolean().optional(),
  organizations: z11.array(z11.string()).optional(),
  visibility: z11.enum(["public", "private", "all"]).optional(),
  include: z11.array(regexPatternSchema).optional(),
  exclude: z11.array(regexPatternSchema).optional()
});
var configSchema = z11.object({
